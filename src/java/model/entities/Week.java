...
public class Week implements Serializable {
	...
	public Week(Integer id, String hourstart, String hourend, String sunday, String monday, String tuesday, String fourth,
	...
	public String toString() {		
		...
		return id + " - " +  hourstart + " - " + hourend + " - " + sunday
